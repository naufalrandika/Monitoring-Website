                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">pH</p>
                                <h5>
                                    <input class="mb-0" id="txtField2" type="text"
                                        style="background-color: transparent; text-align: right; border: 0 black solid; color: black; font-weight: bolder"
                                        readonly disabled>pH
                                </h5>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">DO</p>
                                <h5>
                                    <input class="mb-0" id="txtField3" type="text"
                                        style="background-color: transparent; text-align: right; border: 0 black solid; color: black; font-weight: bolder"
                                        readonly disabled>mg/L
                                </h5>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                    ...
                    <div class="card z-index-2 ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg py-3 pe-1">
                                <div class="chart">
                                    <iframe width="100%" height="260" style="border: 1px solid #cccccc; border-radius: 10%"
                                src="https://thingspeak.com/channels/2057444/charts/1?bgcolor=%23FFFFFF&color=%23fcb26a&days=1&dynamic=true&results=60&title=Suhu+%2F+Temperatur&type=line&xaxis=Jam&yaxis=%C2%B0C"></iframe>
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-sm ">Last Temperature Chart</p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
                                <p id="txtUpdatedTime1" class="mb-0 text-sm">just updated</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card z-index-2 ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                <div class="chart">
                                    <iframe width="100%" height="260" style="border: 1px solid #cccccc; border-radius: 10%"
                                src="https://thingspeak.com/channels/2057444/charts/2?bgcolor=%23ffffff&color=%237568fc&days=1&dynamic=true&results=60&title=Potential+of+Hydrogen&type=line&xaxis=Jam&yaxis=pH"></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <h6 class="mb-0 ">Potential of Hydrogen</h6>
                            <p class="text-sm ">Last Potential of Hydrogen Chart</p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
                                <p id="txtUpdatedTime2" class="mb-0 text-sm">just updated</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card z-index-2  ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-success shadow-success border-radius-lg py-3 pe-1">
                                <div class="chart">
                                    <iframe width="100%" height="260" style="border: 1px solid #cccccc; border-radius: 10%"
                                src="https://thingspeak.com/channels/2057444/charts/3?bgcolor=%23ffffff&color=%2357dcff&days=1&dynamic=true&results=60&title=Dissolved+Oxygen&type=line&xaxis=Jam&yaxis=mg%2FL"></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <h6 class="mb-0 "> Dissolved Oxygen </h6>
                            <p class="text-sm "> Last Dissolved Oxygen Chart </p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
                                <p id="txtUpdatedTime3" class="mb-0 text-sm">just updated</p>
                            </div>
                        </div>
                    </div>
                </div>
